...
if Rails.env.development?
  ...
  user_comment1 = user1.comments.create!(content: "working on the rails project")
  user_comment2 = user2.comments.create!(content: "great experience working on java project")
  user_comment3 = user3.comments.create!(content: "good experience")
  user_comment4 = user4.comments.create!(content: "it is my first project")

  task_comment5 = task1.comments.create!(content: "working on backend developement enhanced my skills")
  task_comment6 = task2.comments.create!(content: "task is quit difficult")
  task_comment7 = task3.comments.create!(content: "springboot is good framework")
  task_comment8 = task5.comments.create!(content: "implementing the dashborad features")
  task_comment9 = task6.comments.create!(content: "found many bugs")
